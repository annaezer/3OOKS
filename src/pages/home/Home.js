                ...
                <div className={styles["background-colour"]}>
                    <div className="inner-container">
                        ...
                        <p className={styles["about-text"]}>We don’t care about money; we just care about having
                            ...
                            from.
                            Easy! This leaves more time to actually read the book! Of course, we don't help you tackle
                            the big
                            problems in life here, but making decisions easier can help reduce stress in your day-to-day
                            life, right?</p>
